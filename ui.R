...
fluidPage(
  ...
  sidebarPanel(
    ...
    selectInput('year', 'Years since Training', c("1","2","3","4","5","6","7","8","9")),
    
    selectInput('Documentation', 'Type of Documentation', c("I-551 CU","I-551 F","I-688B","I-766 a10","I-94","I-94 order of supervision","Prima Facie")),
